function el = initEyelinkDefaultVars(window, screen)
% Initialize eyelink defaults and control code structure

% adapted from sx_EyelinkInitDefaults
...
if ~isempty(window)
	...
	el.backgroundcolour = screen.gray; %screen.bgColor;%GrayIndex(el.window);
