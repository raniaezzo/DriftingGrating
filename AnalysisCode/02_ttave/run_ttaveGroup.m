...
conditions = {'mainCardinalVsMainOblique', 'derivedCardinalVsDerivedOblique', 'radialVsTangential'};

projectSettings = loadConfig(githubDir);

roiNames = projectSettings.rois; %{'V1_REmanual', 'pMT_REmanual', 'hMTcomplex_REmanual', 'pMST_REmanual', 'V2_REmanual', 'V3_REmanual'};

subjects = {'sub-0037', 'sub-0201', 'sub-wlsubj123', 'sub-wlsubj124' , ...
    'sub-0255' , 'sub-0395', 'sub-0426', 'sub-0250'};

% {'sub-0037', 'sub-0201', 'sub-0255', 'sub-0397', ...
...
for ci=1:numel(conditions)
    ...
    for ri=1:numel(roiNames)
        ...
        for si=1:numel(subjects)
            ...
            path2Output = fullfile(path2ses, ses, 'ttaveData', comparisonName, sprintf('ttaveSignal_%s_%s_%s_%s.mat', subjectname, roiName, condName, comparisonName));
