...
hemi = 'lh';
subjectname = 'sub-0255';

flatFile = sprintf('/Volumes/Vision/UsersShare/Rania/Project_dg/data_bids/derivatives/freesurfer/%s/surf/%s.hMTcomplex.patch.flat', subjectname, hemi);
...
prfvistaFile = sprintf('/Volumes/Vision/UsersShare/Rania/Project_dg/data_bids/derivatives/prfvista/%s/ses-02/%s.angle_adj.mgz', subjectname, hemi);

prfvistamov_angname = fullfile(prfvistaFile);
angVol = MRIread(prfvistamov_angname); angVol = angVol.vol;

prfvistaFile = sprintf('/Volumes/Vision/UsersShare/Rania/Project_dg/data_bids/derivatives/prfvista/%s/ses-02/%s.eccen.mgz', subjectname, hemi);
...
fsdir = sprintf('/Volumes/Vision/UsersShare/Rania/Project_dg/data_bids/derivatives/freesurfer/%s/', subjectname);
